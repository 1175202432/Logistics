...
public class CodeGenerator {
	...
	public static void main(String[] args) {
		...
		strategy.setInclude(new String[] {"delivery","driver","emp","goods","orders","orders_audit","out_of_stock","role","stock","truck","user","user_vip","warehouse","warehousing"});
